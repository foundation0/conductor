...
export default function WorkspaceCreate() {
  ...
  useEffect(() => {
    setTimeout(() => fieldFocus({ selector: "input[name='name']" }), 100)
  }, [])
  return (
      ...
      <div className="flex flex-col max-w-sm">
        <div className="flex flex-row mb-5">
          ...
          <div className="flex flex-col justify-center">
            <div className="text-2xl font-semibold mb-2">Create new workspace</div>
            <div className="text-sm text-zinc-300">
              Workspaces separate different contexts. You can create workspaces for work, hobbies, projects, etc.
            </div>
          </div>
        </div>
        <Form
